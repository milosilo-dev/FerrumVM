...
use skhv::{device_maps::{io::IODeviceRegion, mmio::MMIODeviceRegion}, devices::{serial::Serial, timer::Timer}, machine_config::{MachineConfig, MemoryRegion}, vm::VirtualMachine};
...
fn main() {
        ...
        let mut vm = VirtualMachine::new(Vec::from(init_mem_image), 
            MachineConfig{
                ...
                mmio_devices: vec![
                    MMIODeviceRegion::new(0xF0001000..=0xF0001008, timer)
                ],
                code_entry: 0x1000,
            }
        );
